---
title: "Lesson 6: Visual Multivariate Analysis"
date: "`r Sys.Date()`"
format: html
editor: visual
---
...
-   Handout of Hands-on Exercise 5
    ...
    -   [Building Ternary Plot with R](https://r4va.netlify.app/chap13.html).
    -   [Visualising Correlation Matrices with R](https://r4va.netlify.app/chap06.html).
    -   [Building Heatmap for Visualising and Analysing Multivariate Data](https://r4va.netlify.app/chap14.html).
    -   [Building Parallel Coordinates Plot with R](https://r4va.netlify.app/chap15.html).
    -   [Building Treemap Visualisation with R](https://r4va.netlify.app/chap16.html)
