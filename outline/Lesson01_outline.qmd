...
-   Hands-on Exercise 1 in [html](https://r4va.netlify.app/chap01.html) format.

-   In-class Exercise 1 handout and guide in [html](../In-class_Ex/In-class_Ex01/In-class_Ex01.html) format.
